...
public class LoginBean implements Serializable {
	...
	public String login() {
        try {
        	...
        	CommonUtils.addErrorMsg(null, "Username or Password is not correct !", "");
        	account = new Account();
        	return "";
        }
    }
	...
	public void editProfile() {
		...
		if(!email.equals(account.getEmail()) && accountService.findByEmail(account.getEmail()) != null){
	...
	public void forgotPassword() throws IOException {
		Account acc = accountService.findByEmail(forgotEmail);
		if(acc == null) {
			CommonUtils.addErrorMsg(null, "Email is not existed !", "");
		} else {
			isForgotPass = true;
			mailService.sendMail("snowinrain90@gmail.com", acc.getEmail(), "Forgot Password in All Star Group", "Your password is " + new String(CommonUtils.base64Decode(acc.getPassword())));
			forgotEmail = "";
		}
	}
	...
	public String logout() throws IOException{
		...
		if(account.getRole().equals(Constant.ROLE_USER))
        	returnPage = Constant.PAGE_INDEX;
        else
