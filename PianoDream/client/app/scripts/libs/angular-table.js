...
(function() {
  ...
  pagination_template = "<div style='margin: 0px;'> <ul class='pagination' style='margin-top:10px'><li ng-show='show_sectioning()' ng-class='{disabled: get_current_page() <= 0}'> <a href='' ng-click='jump_back()'>&laquo;</a> </li> <li ng-class='{disabled: get_current_page() <= 0}'> <a href='' ng-click='step_page(-1)' style='background: #4b4b4b;cursor: pointer;padding: 2px 6px 2px 6px;margin-left: 2px;margin-right: 1px;border-radius: 5px;border:0px'>&lsaquo;</a> </li> <li ng-class='{active: get_current_page() == page}' ng-repeat='page in page_sequence.data'> <a href='' ng-click='go_to_page(page)' style='background: #4b4b4b;cursor: pointer;padding: 2px 8px 2px 8px;margin-left: 1px;border:0px'>{{page + 1}}</a> </li> <li ng-class='{disabled: get_current_page() >= " + irk_number_of_pages + " - 1}'> <a href='' ng-click='step_page(1)' style='background: #4b4b4b;cursor: pointer;padding: 2px 6px 2px 6px;margin-left: 2px;margin-right: 1px;border-radius: 5px;border:0px'>&rsaquo;</a> </li> <li ng-show='show_sectioning()' ng-class='{disabled: get_current_page() >= " + irk_number_of_pages + " - 1}'> <a href='' ng-click='jump_ahead()'>&raquo;</a> </li> </ul> </div>";
