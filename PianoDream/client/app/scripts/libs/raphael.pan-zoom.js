...
(function () {
    ...
    PanZoom = function (el, options) {
        ...
        function handleScroll(e) {
        	if (!me.isMouseEnable) return false;
            if (!me.enabled) return false;
            var evt = window.event || e,
        ...
        function applyZoomLevel(val, centerPoint) {
        	console.log("applyZoomLevel: " + val);
        	if (!me.enabled) return false;
        	me.currZoom = val;
        ...
        function applyZoom(val, centerPoint) {
            if (!me.enabled) return false;
            val += me.currZoom;
            applyZoomLevel(val, centerPoint);
        }

        this.applyZoom = applyZoom;
        this.applyZoomLevel = applyZoomLevel;
